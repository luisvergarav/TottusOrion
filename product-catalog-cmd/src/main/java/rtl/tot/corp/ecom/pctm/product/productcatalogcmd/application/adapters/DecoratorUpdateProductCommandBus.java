...
@Slf4j
public class DecoratorUpdateProductCommandBus implements CommandBus<UpdateProductCommandImpl> {
	

	@Autowired
	EventPublisherService publisher;
	UpdateProductCommandBus bus;
	
    public DecoratorUpdateProductCommandBus(UpdateProductCommandBus bus) {
    	this.bus = bus;
    }
	...
	public boolean execute(UpdateProductCommandImpl command) throws Exception {
	        ...
	        ProductUpdatedIntegrationEvent integrationEvent = null;
    		try{
    			
    	       
    	        
    	        integrationEvent = new ProductUpdatedIntegrationEvent();
